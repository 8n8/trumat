module Gen.Process exposing (moduleName_, spawn, sleep, kill, annotation_, call_, values_)
...
values_ : { spawn : Elm.Expression, sleep : Elm.Expression, kill : Elm.Expression }
values_ =
    { spawn =
        Elm.value
            { importFrom = [ "Process" ]
