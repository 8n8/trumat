module Gen.List exposing (moduleName_, singleton, repeat, range, map, indexedMap, foldl, foldr, filter, filterMap, length, reverse, member, all, any, maximum, minimum, sum, product, append, concat, concatMap, intersperse, map2, map3, map4, map5, sort, sortBy, sortWith, isEmpty, head, tail, take, drop, partition, unzip, call_, values_)
...
-}
map : (Elm.Expression -> Elm.Expression) -> List Elm.Expression -> Elm.Expression
map mapArg mapArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "List" ]
...
-}
filter : (Elm.Expression -> Elm.Expression) -> List Elm.Expression -> Elm.Expression
...
-}
all : (Elm.Expression -> Elm.Expression) -> List Elm.Expression -> Elm.Expression
all allArg allArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "List" ]
...
-}
any : (Elm.Expression -> Elm.Expression) -> List Elm.Expression -> Elm.Expression
any anyArg anyArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "List" ]
...
-}
concatMap : (Elm.Expression -> Elm.Expression) -> List Elm.Expression -> Elm.Expression
...
-}
sortBy : (Elm.Expression -> Elm.Expression) -> List Elm.Expression -> Elm.Expression
...
-}
partition : (Elm.Expression -> Elm.Expression) -> List Elm.Expression -> Elm.Expression
