module Gen.Elm.Case.Branch exposing (moduleName_, map, var, unit, ignore, int, string, char, tuple, triple, list, listWithRemaining, just, nothing, err, ok, record0, record1, record2, record3, record4, record5, record6, record7, record8, record9, variant0, variant1, variant2, variant3, variant4, variant5, variant6, variant7, variant8, variant9, customType, withParam, toPattern, aliasAs, annotation_, call_, values_)
