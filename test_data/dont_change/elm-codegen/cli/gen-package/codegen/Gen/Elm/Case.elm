module Gen.Elm.Case exposing (moduleName_, maybe, result, list, string, tuple, triple, custom, otherwise, branch0, branch1, branch2, branch3, branch4, branch5, branch6, branchWith, branchList, annotation_, call_, values_)
...
-> Elm.Expression
-}
custom : Elm.Expression -> Elm.Expression -> List Elm.Expression -> Elm.Expression
...
-}
branchWith : String -> Int -> (Elm.Expression -> Elm.Expression) -> Elm.Expression
