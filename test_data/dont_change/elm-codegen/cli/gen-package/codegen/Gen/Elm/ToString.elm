module Gen.Elm.ToString exposing (moduleName_, expression, annotation, declaration, expressionWith, annotationWith, declarationWith, call_, values_)
...
-}
expressionWith : { aliases : List Elm.Expression } -> Elm.Expression -> Elm.Expression
...
-}
annotationWith : { aliases : List Elm.Expression } -> Elm.Expression -> Elm.Expression
...
-> { imports : String, docs : String, signature : String, body : String }
-}
declarationWith : { aliases : List Elm.Expression } -> Elm.Expression -> Elm.Expression
