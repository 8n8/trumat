...
urlSchemes :: Set Text
urlSchemes =
  Set.fromList ["aaa", "http", "https", "acap", "adiumxtra", "afp", "afs", "aim", "apt", "attachment", "aw", "beshare", "bitcoin", "bolo", "callto", "cap", "chrome", "cid", "coap", "content", "crid", "cvs", "data", "dav", "dict", "dns", "doi"]
