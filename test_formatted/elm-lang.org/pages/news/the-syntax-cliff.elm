module Main exposing (badImport, capitalNameError, color, cyan, def, dullCyan, dullYellow, green, intro, keyword, main, missingCurlyBrace, part1, part2, part3, purple, red, underline, viewErrorMessage)
...
badImport =
    viewErrorMessage
        [ color keyword "import"
        , text " * "
        , color keyword "as"
        , text " Set "
        , color keyword "from"
        , text " 'set'\n\n"
        , color keyword "type alias"
        , text " "
        , color def "Student"
        , text " =\n"
...
missingCurlyBrace =
    viewErrorMessage
        ...
        , text " next and see\nif that helps?\n\n"
        , underline "Note"
        , text ": I may be confused by indentation. For example, if you are trying to define\n"
...
capitalNameError =
    viewErrorMessage
        ...
        , color red "^"
        , text "\nTry a name like "
        , color green "toFullName"
        , text " instead?\n\n"
        , underline "Note"
        , text ": Here are a couple valid declarations for reference:\n\n"
        , text "    greet : String -> String\n"
        , text "    greet name =\n"
        , text "      "
        , color dullYellow "\"Hello \""
        , text " ++ name ++ "
        , color dullYellow "\"!\"\n\n"
        , text "    "
        , color cyan "type"
        , text " User = Anonymous | LoggedIn String\n\n"
