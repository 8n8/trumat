module Main exposing (News, Release, Video, main, news, releases, videos, viewNews, viewRelease, viewVideo)
...
videos =
    ...
    , Video "The Hard Parts of Open Source"
        "https://thestrangeloop.com/2018/the-hard-parts-of-open-source.html"
        2018
    ...
    , Video "Code is the Easy Part"
        "https://youtu.be/DSjbTC-hvqQ"
        2016
    ...
    , Video "Accidentally Concurrent"
        "https://youtu.be/DfLvDFxcAIA"
        2015
    ...
    , Video "Controlling Time and Space"
        "https://youtu.be/Agu6jipKfYw"
        2015
    ...
    , Video "Functional Reactive Programming in Elm"
    ...
    , Video "Elm: Making the Web Functional"
