module Gen.Platform.Cmd exposing (moduleName_, none, batch, map, annotation_, call_, values_)
...
values_ : { none : Elm.Expression, batch : Elm.Expression, map : Elm.Expression }
values_ =
    { none =
        Elm.value
            { importFrom = [ "Cmd" ]
