module Gen.Tuple exposing (moduleName_, pair, first, second, mapFirst, mapSecond, mapBoth, call_, values_)
...
-}
mapFirst : (Elm.Expression -> Elm.Expression) -> Elm.Expression -> Elm.Expression
...
-}
mapSecond : (Elm.Expression -> Elm.Expression) -> Elm.Expression -> Elm.Expression
