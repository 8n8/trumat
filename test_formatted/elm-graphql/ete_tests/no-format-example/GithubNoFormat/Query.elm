...
-}
meta :
    SelectionSet decodesTo GithubNoFormat.Object.GitHubMetadata
    -> SelectionSet decodesTo RootQuery
meta object____ =
...
type alias NodeRequiredArguments =
    { id : GithubNoFormat.ScalarCodecs.Id }
...
type alias NodesRequiredArguments =
    { ids : List GithubNoFormat.ScalarCodecs.Id }
...
type alias ResourceRequiredArguments =
    { url : GithubNoFormat.ScalarCodecs.Uri }
